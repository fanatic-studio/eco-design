<template>
    <div ref="mySwitch" @click="changeState" :style="getBgStyle">
        <div ref="myBall" :style="ballStyle"></div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.wRatio = this.$refs.mySwitch.style.width / 144;
            this.hRatio = this.$refs.mySwitch.style.height / 72;
        ...
        methods: {
            ...
            toggleState(bool, animated = true) {
                ...
                const myBall = this.$refs.myBall;
                if (!myBall) {
                    return;
                }
                animation.transition(myBall, {
                    styles: style,
                    timingFunction: 'ease',
